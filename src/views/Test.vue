...
import { BarChartOutlined, TableOutlined, RightOutlined } from "@ant-design/icons-vue";
            ...
            <div class="checkable-area">
                <div class="button-area">
                    <a-button v-for="cat in category" :key="cat" class="category-btn"
                        :class="{ active: selectedCategories.includes(cat) }" @click="selectCategory(cat)">{{ cat
                        }}</a-button>
                </div>
